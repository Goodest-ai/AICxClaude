...
A career diagnosis tool for 3rd-year Tier-2 Indian engineering students. User pastes resume + target JD, Codex returns a ranked, confidence-labeled list of likely rejection reasons with additive fixes calibrated to their time horizon.

Built solo for the AIC × Anthropic Codex Hackathon (24h). Stage: prototype v0.1. Demo-readiness > feature-completeness.
...
app/
  ...
  api/diagnose/route.js    Server-side Codex call. Holds ANTHROPIC_API_KEY.
